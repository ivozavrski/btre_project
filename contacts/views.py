...
def contact(request):
    if request.method == 'POST':
        ...
        # Check if user has maid inquiry already
        ...
        #send email
        """ send_mail(
            'Property Listing Inguiry',
            'There has been an Unguiry for ' + listing + '. Sign into the admin panel for more info',
            'izavrski@me.com',
            [realtor_email,'izavrski@me.com'],
            fail_silently=False
        ) """
